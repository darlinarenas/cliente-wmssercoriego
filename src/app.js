...
function buildRouter(){
  ...
  router=new Router({
    ...
    'etiquetas-productos':secureRoute('etiquetas',()=>renderLabels(root,'PRODUCTO','etiquetas-productos')),
    'etiquetas-racks':secureRoute('etiquetas',()=>renderLabels(root,'RACK','etiquetas-racks')),
    'etiquetas-pallets':secureRoute('etiquetas',()=>renderLabels(root,'PALLET','etiquetas-pallets')),
