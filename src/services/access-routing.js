...
export function codePermissionsForUser(user,siteId){
 ...
 return {consult:typeof custom.codesConsult==='boolean'?custom.codesConsult:defaults.consult,associate:typeof custom.codesAssociate==='boolean'?custom.codesAssociate:defaults.associate,associateQuantity:typeof custom.codesQuantityAssociate==='boolean'?custom.codesQuantityAssociate:defaults.associateQuantity,editProduct:typeof custom.productsEdit==='boolean'?custom.productsEdit:defaults.editProduct,editInventory:typeof custom.inventoryAdjust==='boolean'?custom.inventoryAdjust:defaults.editInventory,physicalStock:typeof custom.physicalStockAdjust==='boolean'?custom.physicalStockAdjust:defaults.physicalStock,initialStock:typeof custom.initialStockLoad==='boolean'?custom.initialStockLoad:defaults.initialStock,printLabels:typeof custom.labelsPrint==='boolean'?custom.labelsPrint:defaults.printLabels,createProduct:typeof custom.productsEdit==='boolean'?custom.productsEdit:defaults.createProduct,changeSku:typeof custom.changeSku==='boolean'?custom.changeSku:defaults.changeSku,reconcileErp:typeof custom.reconcileErp==='boolean'?custom.reconcileErp:defaults.reconcileErp,applyErpStock:typeof custom.applyErpStock==='boolean'?custom.applyErpStock:defaults.applyErpStock};
}
...
export function palletPermissionsForRole(role){
 ...
 return {view:operator,operate:operator,register:manage,edit:manage,delete:manage,cleanupResidual:manage};
}
...
export function palletPermissionsForUser(user,siteId){
 ...
 if(assignment?.customPermissions!==true)return defaults;
 const custom=assignment.permissions||{};
 return {view:typeof custom.palletsView==='boolean'?custom.palletsView:defaults.view,operate:typeof custom.palletsOperate==='boolean'?custom.palletsOperate:defaults.operate,register:typeof custom.palletsRegister==='boolean'?custom.palletsRegister:defaults.register,edit:typeof custom.palletsEdit==='boolean'?custom.palletsEdit:defaults.edit,delete:typeof custom.palletsDelete==='boolean'?custom.palletsDelete:defaults.delete,cleanupResidual:typeof custom.palletsCleanupResidual==='boolean'?custom.palletsCleanupResidual:defaults.cleanupResidual};
}
