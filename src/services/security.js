...
export function requireAdminSupercode(context='Esta eliminación requiere autorización administrativa.',{title='Confirmar eliminación',buttonLabel='Autorizar eliminación'}={}){
  return new Promise(resolve=>{
    ...
    dlg.querySelector('#supercode-title').textContent=title; dlg.querySelector('#supercode-submit').textContent=buttonLabel; dlg.querySelector('#supercode-context').textContent=context; input.value=''; error.textContent=''; error.classList.remove('show');
