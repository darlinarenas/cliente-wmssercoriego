...
function modoRapido(palletId){
  return `<div class="quick-location-head"><div><span class="eyebrow">DOBLE ESCANEO</span><h3>Producto → ubicación → confirmar</h3><p>Escanea la caja y luego la etiqueta física de la posición. La cantidad parte en 1 para agilizar R6–R9.</p></div><button id="cerrar-modo-rapido" class="ghost" type="button">Cerrar</button></div>
    ...
    <label><span class="quick-step-number">2</span><b>Ubicación</b><div class="pallet-destination-actions compact"><button id="quick-scan-location" type="button" class="secondary pallet-action-button">▣ Escanear</button><button id="quick-map-location" type="button" class="secondary pallet-action-button">▦ Elegir en mapa</button></div><div class="scan-line"><input id="quick-location" placeholder="Ej. REC-R6-M3-N4" autocomplete="off"></div><small id="quick-location-status">Escanea, elige en mapa o escribe el código de la posición.</small></label></div>
